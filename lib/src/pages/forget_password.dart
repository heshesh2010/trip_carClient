...
class _ForgetPasswordWidgetState extends StateMVC<ForgetPasswordWidget> {
  UserController _con;
  final RoundedLoadingButtonController _btnControllerRest =
...
//              height: config.App(context).appHeight(55),
                child: Form(
                  key: _con.resetPassFirstFormKey,
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      RoundedLoadingButton(
                        ...
                        onPressed: () {
                          _con.restPassFirstStep(_btnControllerRest);
                        },
                      ),
                    ],
                  ),
